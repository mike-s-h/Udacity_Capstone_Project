...
# cities/states downloaded from source: https://github.com/agalea91/city_to_state_dictionary
...
#create udf to return the city of the state
state_udf=udf(lambda x: cities_states[x],StringType())